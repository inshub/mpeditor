...
Desktop editor for WeChat article layout built with Tauri v2 + React 19 + TypeScript + shadcn/ui.
...
To release a new version, update these 3 files with the new version number:

1. **package.json** - Frontend version: `"version": "X.Y.Z"`
2. **src-tauri/Cargo.toml** - Rust version: `version = "X.Y.Z"`
3. **src-tauri/tauri.conf.json** - Tauri config: `"version": "X.Y.Z"`
